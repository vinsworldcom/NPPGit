...
#define IDC_BTN_DIFF      (IDB_TOOLBAR1 + 8)
#define IDC_BTN_ADD       (IDB_TOOLBAR1 + 9)
#define IDC_BTN_UNSTAGE   (IDB_TOOLBAR1 + 10)
#define IDC_BTN_RESTORE   (IDB_TOOLBAR1 + 11)
#define IDC_BTN_LOG       (IDB_TOOLBAR1 + 12)
#define IDC_BTN_BLAME     (IDB_TOOLBAR1 + 13)
#define IDC_BTN_REFRESH   (IDB_TOOLBAR1 + 14)
#define IDC_BTN_GITPATH   (IDD_PLUGINGITPANEL + 101)
